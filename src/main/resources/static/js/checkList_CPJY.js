...
// 点击标签页1，显示主表信息，隐藏子表信息
tab1.addEventListener("click", function() {
    subTable.classList.add("tab-content");
    mainTable.classList.remove("tab-content");
});

// 点击标签页2，显示子表信息，隐藏主表信息
...
var recordCD = document.getElementById("recordCD");
// 绑定按钮点击事件
recordCD.addEventListener("click", function() {
    openRecordCD();
});
...
function openRecordCD() {
    ...
    var left = (window.innerWidth - 800) / 2; // 800是新窗口的宽度
    var top = (window.innerHeight - 600) / 2; // 600是新窗口的高度
    recordCDPopup = window.open('URL2', '疵点明细' + popupCounter, 'width=800, height=400, left=' + left + ', top=' + top);
    var popupDocument = recordCDPopup.document;
    ...
    var buttonSBF = popupDocument.createElement("button");
    ...
    buttonDiv.appendChild(buttonDM);
    buttonDiv.appendChild(buttonPYSZ);
    buttonDiv.appendChild(buttonWZ);
    buttonDiv.appendChild(buttonCS);
    buttonDiv.appendChild(buttonBZY);
    buttonDiv.appendChild(buttonDT);
    buttonDiv.appendChild(buttonPASSBJ);
    buttonDiv.appendChild(buttonPB);
    buttonDiv.appendChild(buttonTCD);
    buttonDiv.appendChild(buttonCW);
    buttonDiv.appendChild(buttonHDSZ);
    buttonDiv.appendChild(buttonCSHS);
    buttonDiv.appendChild(buttonPD);
    buttonDiv.appendChild(buttonPL);
    buttonDiv.appendChild(buttonSBJ);
    buttonDiv.appendChild(buttonTZ);
    buttonDiv.appendChild(buttonZJ);
    buttonDiv.appendChild(buttonFKY);
    buttonDiv.appendChild(buttonDJDW);
    buttonDiv.appendChild(buttonCJCW);
    buttonDiv.appendChild(buttonKJJ);
    buttonDiv.appendChild(buttonLS);
    buttonDiv.appendChild(buttonJZ);
    buttonDiv.appendChild(buttonHD);
    buttonDiv.appendChild(buttonSC);
    buttonDiv.appendChild(buttonJBY);
    buttonDiv.appendChild(buttonCXJ);
    buttonDiv.appendChild(buttonSQB);
    buttonDiv.appendChild(buttonDDY);
    buttonDiv.appendChild(buttonSL);
    buttonDiv.appendChild(buttonBD);
    buttonDiv.appendChild(buttonSJZY);
